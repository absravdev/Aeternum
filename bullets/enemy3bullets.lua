Enemy3Bullets = {}
Enemy3Bullets.__index = Enemy3Bullets
Enemy3Bullets.bullet = love.graphics.newImage('sprites/bullet/bullet.png')
...
function Enemy3Bullets:new(x, y, angle, bulletSpeed)
    local bullet = {}
    setmetatable(bullet, Enemy3Bullets)
    bullet.x = x
    bullet.y = y
...
function Enemy3Bullets:update(bullets, dt)
