Enemy6Bullets = {}
Enemy6Bullets.__index = Enemy6Bullets
Enemy6Bullets.bullet = love.graphics.newImage('sprites/bullet/bullet.png')
...
function Enemy6Bullets:new(x, y, angle, bulletSpeed)
    local bullet = {}
    setmetatable(bullet, Enemy6Bullets)
    bullet.x = x
    bullet.y = y
...
function Enemy6Bullets:update(bullets, dt)
