Enemy2Bullets = {}
Enemy2Bullets.__index = Enemy2Bullets
Enemy2Bullets.bullet = love.graphics.newImage('sprites/bullet/bullet.png')
...
function Enemy2Bullets:new(x, y, angle, bulletSpeed)
    local bullet = {}
    setmetatable(bullet, Enemy2Bullets)
    bullet.x = x
    bullet.y = y
...
function Enemy2Bullets:update(bullets, dt)
