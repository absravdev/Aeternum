Planet5level3 = {}
Planet5level3.__index = Planet5level3
...
sprites.enemy4 = love.graphics.newImage('sprites/enemy/darkenemy4planet5.png')
...
function Planet5level3:playerMouseAngle()
   return math.atan2(player.y - love.mouse.getY(), player.x - love.mouse.getX()) + math.pi
end
function Planet5level3:zombiePlayerAngle(enemy)
   return math.atan2(player.y - enemy.y, player.x - enemy.x)
end
return Planet5level3