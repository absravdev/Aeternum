Planet5level2 = {}
Planet5level2.__index = Planet5level2
...
local player
local gameEnemy1 = Enemy1.new(Data.lvl14.enemy1.maxTime)
local gameEnemy2 = Enemy2.new(Data.lvl14.enemy2.maxTime)
--local gameEnemy3 = Enemy3.new(Data.lvl14.enemy3.maxTime)
local gameEnemy4 = Enemy4.new(Data.lvl14.enemy4.maxTime)
--local gameEnemy5 = Enemy5.new(Data.lvl14.enemy5.maxTime)
--local gameEnemy6 = Enemy6.new(Data.lvl14.enemy6.maxTime)
local enemy1 = {}
local enemy2 = {}
local enemy3 = {}
local enemy4 = {}
...
local a = true
local b = true
function Planet5level2.new()
   local self = setmetatable({}, Planet5level2)
   return self
end
function Planet5level2:update(dt)
   if Data.player.lifepoints <= 0 then
      Data.currentState = "gameovermenu"
   end 
   if Data.player.deadgameenemies >= Data.lvl14.maxKills then
      Data.lvl14.completed = true
   end
   if Data.lvl14.completed == true then
   ...
   player:update(dt)
   gameEnemy1:update(enemy1, Data.lvl14.enemy1.speed, dt)
   gameEnemy2:update(enemy2, player, playerbullets, Data.lvl14.enemy2.speed, Data.lvl14.enemy2.fireRate, Data.lvl14.enemy2.bulletSpeed, dt)
   --gameEnemy3:update(enemy3, player, playerbullets, Data.lvl14.enemy3.speed, Data.lvl14.enemy3.fireRate, Data.lvl14.enemy3.bulletSpeed, dt)
   gameEnemy4:update(enemy4, Data.lvl14.enemy4.speed, dt)
   --gameEnemy5:update(enemy5, player, playerbullets, Data.lvl14.enemy5.speed, Data.lvl14.enemy5.fireRate, Data.lvl14.enemy5.bulletSpeed, dt)
   --gameEnemy6:update(enemy6, player, playerbullets, Data.lvl14.enemy6.speed, Data.lvl14.enemy6.fireRate, Data.lvl14.enemy6.bulletSpeed, dt)
...
function Planet5level2:playerMouseAngle()
   return math.atan2(player.y - love.mouse.getY(), player.x - love.mouse.getX()) + math.pi
end
function Planet5level2:zombiePlayerAngle(enemy)
   return math.atan2(player.y - enemy.y, player.x - enemy.x)
end
return Planet5level2