Planet1level3 = {}
Planet1level3.__index = Planet1level3
...
sprites.enemy4 = love.graphics.newImage('sprites/enemy/darkenemy4planet1.png')
sprites.enemy5 = love.graphics.newImage('sprites/enemy/darkenemy5planet1.png')
sprites.enemy6 = love.graphics.newImage('sprites/enemy/darkenemy6planet1.png')
local player
local gameEnemy1 = Enemy1.new(Data.lvl3.enemy1.maxTime)
local gameEnemy2 = Enemy2.new(Data.lvl3.enemy2.maxTime)
--local gameEnemy3 = Enemy3.new(Data.lvl3.enemy3.maxTime)
--local gameEnemy4 = Enemy4.new(Data.lvl3.enemy4.maxTime)
--local gameEnemy5 = Enemy5.new(Data.lvl3.enemy5.maxTime)
--local gameEnemy6 = Enemy6.new(Data.lvl3.enemy6.maxTime)
local enemy1 = {}
local enemy2 = {}
local enemy3 = {}
local enemy4 = {}
...
local a = true
local b = true
function Planet1level3.new()
   local self = setmetatable({}, Planet1level3)
   Data.currentlvl = 3
   return self
end
function Planet1level3:update(dt)
   if Data.player.lifepoints <= 0 then
      Data.currentState = "gameovermenu"
   end
   if Data.player.deadgameenemies >= Data.lvl3.maxKills then
      Data.lvl3.completed = true
   end
   if Data.lvl3.completed == true then
   ...
   player:update(dt)
   gameEnemy1:update(enemy1, Data.lvl3.enemy1.speed, dt)
   gameEnemy2:update(enemy2, player, playerbullets, Data.lvl3.enemy2.speed, Data.lvl3.enemy2.fireRate, Data.lvl3.enemy2.bulletSpeed, dt)
   --gameEnemy3:update(enemy3, player, playerbullets, Data.lvl3.enemy3.speed, Data.lvl3.enemy3.fireRate, Data.lvl3.enemy3.bulletSpeed, dt)
   --gameEnemy4:update(enemy4, Data.lvl3.enemy4.speed, dt)
   --gameEnemy5:update(enemy5, player, playerbullets, Data.lvl3.enemy5.speed, Data.lvl3.enemy5.fireRate, Data.lvl3.enemy5.bulletSpeed, dt)
   --gameEnemy6:update(enemy6, player, playerbullets, Data.lvl3.enemy6.speed, Data.lvl3.enemy6.fireRate, Data.lvl3.enemy6.bulletSpeed, dt)
...
function Planet1level3:playerMouseAngle()
   return math.atan2(player.y - love.mouse.getY(), player.x - love.mouse.getX()) + math.pi
end
function Planet1level3:zombiePlayerAngle(enemy)
   return math.atan2(player.y - enemy.y, player.x - enemy.x)
end
return Planet1level3